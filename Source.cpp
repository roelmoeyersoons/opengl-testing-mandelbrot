...
int main()
{
    ...
    ShaderLoader lightingShader("Shaders/Vertex/object.vs", "Shaders/Fragment/object.fs");
    ShaderLoader lightCubeShader("Shaders/Vertex/lightSource.vs", "Shaders/Fragment/lightSource.fs");

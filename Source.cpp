...
int main()
{
    ...
    ShaderLoader lightingShader("Shaders/Vertex/vertex.vs", "Shaders/Fragment/object.fs");
    ShaderLoader lightCubeShader("Shaders/Vertex/vertex.vs", "Shaders/Fragment/lightSource.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       //transform = glm::rotate(transform, (float)glfwGetTime(), glm::vec3(1.0f, 1.0f, 0.0f));
        ...
        lightingShader.setVec3("lightColor", 0.5f, 1.0f, 1.0f);
